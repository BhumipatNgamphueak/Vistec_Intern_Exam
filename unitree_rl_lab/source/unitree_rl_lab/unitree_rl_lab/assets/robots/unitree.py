...
##
# Go2 with MLP Actuator Network (Trained from Gazebo Data)
##

UNITREE_GO2_MLP_CFG = UnitreeArticulationCfg(
    spawn=UnitreeUsdFileCfg(
        usd_path=f"{UNITREE_MODEL_DIR}/Go2/go2.usd",
    ),
    init_state=ArticulationCfg.InitialStateCfg(
    ...
    actuators={
        "legs": unitree_actuators.UnitreeActuatorCfg_Go2_MLP(
            joint_names_expr=[".*"],
        ),
    },
    # fmt: off
...
##
# Go2 with LSTM Actuator Network (Trained from Gazebo Data)
##

UNITREE_GO2_LSTM_CFG = UnitreeArticulationCfg(
    spawn=UnitreeUsdFileCfg(
        usd_path=f"{UNITREE_MODEL_DIR}/Go2/go2.usd",
    ),
    init_state=ArticulationCfg.InitialStateCfg(
    ...
    actuators={
        "legs": unitree_actuators.UnitreeActuatorCfg_Go2_LSTM(
            joint_names_expr=[".*"],
        ),
    },
    # fmt: off
...
UNITREE_GO2W_CFG = UnitreeArticulationCfg(
    ...
    # ),
    spawn=UnitreeUsdFileCfg(
        usd_path=f"{UNITREE_MODEL_DIR}/Go2W/go2w.usd",
    ),
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 0.45),
        joint_pos={
...
UNITREE_B2_CFG = UnitreeArticulationCfg(
    ...
    # ),
    spawn=UnitreeUsdFileCfg(
        usd_path=f"{UNITREE_MODEL_DIR}/B2/b2.usd",
    ),
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 0.58),
        joint_pos={

...
from unitree_rl_lab.assets.robots.unitree import UNITREE_GO2_MLP_CFG as ROBOT_CFG  # Using MLP Actuator
...
class RobotSceneCfg(InteractiveSceneCfg):
    ...
    height_scanner = RayCasterCfg(
        ...
        attach_yaw_only=True,  # Replaces ray_alignment="yaw" for Isaac Lab 4.5
...
class ObservationsCfg:
    ...
    class CriticCfg(ObsGroup):
        ...
        # joint_effort = ObsTerm(func=mdp.joint_effort, scale=0.01, clip=(-100, 100))  # Not available in this version
        last_action = ObsTerm(func=mdp.last_action, clip=(-100, 100))
